...
| contentBitrate           | Measured average throughput (in bits per second) during video playback, representing actual content consumption rate. Falls back to current quality bitrate from manifest if throughput measurement is unavailable. |
